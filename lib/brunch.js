(function() {
  ...
  exports.collectDependencies = function(sourcePath) {
    var additionalLibaries, args, brunchLibaries, dependencies, dependencyPaths, filenames;
    brunchLibaries = ['ConsoleDummy.js', 'jquery-1.5.2.js', 'underscore-1.1.5.js', 'backbone-master.js'];
