...
const updateMap = function(path, compiled, wrapped, sourceMap) {
...
const updateCache = function(path, cache, error, result, wrap) {
...
const makeWrapper = function(wrapper, path, isWrapped, isntModule) {
...
const makeCompiler = function(path, cache, linters, compilers, wrap) {
  var normalizedPath;
