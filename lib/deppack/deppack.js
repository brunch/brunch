...
class Deppack {
  constructor(config, json) {
    ...
    this.getPackageJson = filePath => {
      return helpers.packageJson(filePath, this.rootPackage);
    };
  }
  ...
  exploreDeps(sourceFile) {
    return explore(this.depGraph, this.modMap, this.usedShims, this.getPackageJson, this.isProduction, this.fileReflection, this.resolve)(sourceFile);
  }
