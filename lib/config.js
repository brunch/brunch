...
const configBaseSchema = v.object({
  ...
  notifications: v.either(v.bool, v.array(v.string)).default(true),
...
const loadConfig = (persistent, opts, fromWorker) => {
...
const loadConfigWorker = (persistent, opts) => {
  return loadConfig(persistent, opts, true);
};
