(function() {
  ...
  exports["new"] = function(options, callback) {
    ...
    return path.exists(exports.options.brunchPath, function(exists) {
      ...
      return helpers.copy(path.join(projectTemplatePath, 'src/'), path.join(exports.options.brunchPath, 'src'), function() {
        helpers.copy(path.join(projectTemplatePath, 'build/'), exports.options.buildPath, function() {});
        if (exports.options.projectTemplate === "express") {
          helpers.copy(path.join(projectTemplatePath, 'server/'), path.join(exports.options.brunchPath, 'server'), function() {
            return callback();
          });
        } else {
          callback();
