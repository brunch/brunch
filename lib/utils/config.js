...
async function tryToLoad(root, configPath, pkg) {
  ...
  if (pkg.brunch) {
    ...
    brunchConfig = Object.assign({}, DEFAULT_CONFIG_CONTENTS, pkg.brunch);
  } else if (await exists(fullConfigPath)) {
    ...
    brunchConfig = Object.assign({}, DEFAULT_CONFIG_CONTENTS, config);
  } else {
