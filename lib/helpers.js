...
const deepFreeze = exports.deepFreeze = function(object) {
...
const replaceConfigSlashes = exports.replaceConfigSlashes = function(config) {
  var files;
  if (!isWindows) {
    return config;
  }
...
const createJoinConfig = function(configFiles) {
...
const normalizeDefinition = function(typeOrFunction) {
  switch (typeOrFunction) {
    case 'commonjs':
      return function() {
...
const warnAboutConfigDeprecations = function(config) {
...
const addDefaultServer = function(config) {
