(function() {
  var colors, fs, glob, helpers, package, path, root, spawn, stitch, sys, timeouts, util, vendorPath;
  root = __dirname + "/../";
  util = require('util');
  fs = require('fs');
  path = require('path');
  ...
  package = stitch.createPackage({
    dependencies: ["" + vendorPath + "ConsoleDummy.js", "" + vendorPath + "jquery-1.5.1.js", "" + vendorPath + "underscore-1.1.5.js", "" + vendorPath + "backbone-0.3.3.js"],
